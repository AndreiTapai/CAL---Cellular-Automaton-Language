...
expression          : expression '+' expression                              { $$ = new CalVal(new ExpressionNode((ExpressionNode)$1.obj, $2.sval, (ExpressionNode)$3.obj)); }
                    ...
                    | variable '[' arrayIndex ']'                            { $$ = new CalVal(new ExpressionNode($1.sval+$2.sval+$3.sval+$4)); }
...
conditional         : expression condition expression                        { $$ = new CalVal(new ConditionalNode((ExpressionNode)$1.obj, $2.sval, (ExpressionNode)$3.obj)); }
                    ...
                    ;
iteration           : IF '(' conditional ')' block                                       { $$ = new CalVal(new IterationStatementNode($1.sval, $3.sval, (BlockNode)$5.obj)); }       
                    | IF '(' conditional ')' block elseif                                { $$ = new CalVal(new IterationStatementNode($3.sval, (BlockNode)$5.obj, $6.sval)); }
                    | IF '(' conditional ')' block elseif ELSE block                     { $$ = new CalVal(new IterationStatementNode($3.sval, (BlockNode)$5.obj, $6.sval, (BlockNode)$8.obj)); }
                    | IF '(' conditional ')' block ELSE block                            { $$ = new CalVal(new IterationStatementNode($3.sval, (BlockNode)$5.obj, (BlockNode)$7.obj)); }
...
variableDefinition  : type VARIABLE '=' expression                          { $$ = new CalVal(new VariableDefinitionNode($1.sval+$2.sval,$3.sval, (ExpressionNode)$4.obj)); }                  
                    | VARIABLE '[' arrayIndex ']' '=' expression            { $$ = new CalVal(new VariableDefinitionNode($1.sval+$2.sval+$3.sval+$4.sval,$5.sval,(ExpressionNode)$6.obj)); }
